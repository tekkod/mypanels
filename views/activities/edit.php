...
<div class="container t-top hidden-xs ">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 t-rgba-f t-sag" style="height: 450px">
            <form class="form-horizontal" method="post" action="<?=URL?>activities/editSave/<?=$this->activities[0]['activities_id']; ?>">
                <fieldset>
                    <!-- Form Name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtTitle" name="txtTitle" type="text" placeholder="Başlık" class="form-control input-md" value="<?=$this->activities[0]['title']; ?>">
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtLocation" name="txtLocation" type="text" placeholder="Konum" class="form-control input-md" value="<?=$this->activities[0]['location']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="txtStart" class="form-control pull-right" id="reservation" value="<?=$this->activities[0]['start']; ?>">
                            </div><!-- /.input group -->
                        </div>
                    </div>
                    <!-- Textarea input-->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <textarea id="txtDescription" name="txtDescription" type="text" placeholder="Açıklama"><?=$this->activities[0]['description']; ?></textarea>
                        </div>
                    </div>
                    <!-- Button (Double) -->
                    <div class="form-group">
