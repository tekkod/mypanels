...
<div class="container t-top hidden-xs ">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 t-rgba-f t-sag">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= URL ?>slider/editSave/<?php echo $this->slider[0]['slider_id']; ?>">
                <fieldset>
                    <!-- Form Name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtQuestionName" name="txtQuestionName" placeholder="Slider Adı" class="form-control input-md" type="text" required="" value="<?php echo $this->slider[0]['slidername']; ?>">
