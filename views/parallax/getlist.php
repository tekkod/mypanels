                ...
                <table id="table" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        foreach($this->parallax as $key => $value) {
                            echo '<tr>';
                            echo '<td>'.$value['parallaxname'].'</td>';
                            echo '<td class="col-md-1"><a href="'. URL . 'parallax/edit/' . $value['parallax_id'].'"><i class="fa fa-pencil fa-2x"></i></a></td>';
                            echo '<td class="col-md-1"><a class="delete" href="'. URL . 'parallax/delete/' . $value['parallax_id'].'"><i class="fa fa-trash fa-2x"></i></a></td>';
                            echo '</tr>';
                        }
                        ?>
                    </tbody>
