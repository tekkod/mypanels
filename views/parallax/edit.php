...
<div class="container t-top hidden-xs ">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 t-rgba-f t-sag">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>parallax/editSave/<?php echo $this->parallax[0]['parallax_id']; ?>" style="overflow-y:scroll;height:450px;padding:20px;">
                <fieldset>
                    <!-- Form Name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtparallaxname" name="txtparallaxname" placeholder="Parallax Adı" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['parallaxname']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col lg-2 col-md-2 col-sm-3 col-xs-3" for="txtinitialleft">Sol Başlangıç</label>
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtinitialleft" name="txtinitialleft" placeholder="Sol Başlangıç" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['initialleft']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtinitialtop" name="txtinitialtop" placeholder="Üst Başlangıç" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['initialtop']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtfinalleft" name="txtfinalleft" placeholder="Sol Bitiş" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['finalleft']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtfinaltop" name="txtfinaltop" placeholder="Üst Bitiş" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['finaltop']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtduration" name="txtduration" placeholder="Süre" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['duration']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtfadestart" name="txtfadestart" placeholder="Solma Başlangıcı" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['fadestart']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtcontinuousleft" name="txtcontinuousleft" placeholder="Sol Süreklilik" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['continuousleft']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtcontinuoustop" name="txtcontinuoustop" placeholder="Üst Süreklilik" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['continuoustop']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtcontinuouseasing" name="txtcontinuouseasing" placeholder="Animasyon" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['continuouseasing']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtcontinuousduration" name="txtcontinuousduration" placeholder="Süre" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['continuousduration']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtdurationrotate" name="txtdurationrotate" placeholder="Döndürme Süresi" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['durationrotate']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtdelay" name="txtdelay" placeholder="Bekleme Süresi" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['delay']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtexittop" name="txtexittop" placeholder="Üst Çıkış" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['exittop']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtexitduration" name="txtexitduration" placeholder="Animasyon Çıkış" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['exitduration']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtexitdelay" name="txtexitdelay" placeholder="Bekletme Çıkış" class="form-control input-md" type="text" required="" value="<?php echo $this->parallax[0]['exitdelay']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <button id="txtbutton" class="btn btn-success"><i class="fa fa-pencil"></i> Güncelle</button>
