...
<div class="container t-top hidden-xs ">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 t-rgba-f t-sag">
            <form class="form-horizontal" method="post" action="<?= URL ?>subcategory/create">
                <fieldset>
                    <!-- Form Name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input id="txtSubCategory" name="txtSubCategory" type="text" placeholder="Alt Kategori Adı" class="form-control input-md" required="">
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Text input-->
