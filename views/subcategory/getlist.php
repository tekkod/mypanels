        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 t-rgba-f t-sag">
            <div class="table-responsive">
                <table id="table" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                            foreach($this->SubCategoryList as $key => $value) {
                                echo '<tr>';
                                echo '<td>' . $value['cname'] . '</td>';
                                echo '<td>' . $value['scname'] . '</td>';
                                ...
                                echo '<td class="col-md-1"><a href="'. URL . 'subcategory/edit/' . $value['subcategory_id'].'"><i class="fa fa-pencil fa-2x"></i></a></td>';
                                echo '<td class="col-md-1"><a class="delete" href="'. URL . 'subcategory/delete/' . $value['subcategory_id'].'"><i class="fa fa-trash fa-2x"></i></a></td>';
                                echo '</tr>';
                            }
                        ?>
                    </tbody>
