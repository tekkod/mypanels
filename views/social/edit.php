...
<div class="container t-top hidden-xs ">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 t-rgba-f t-sag" style="overflow-y: scroll;height: 450px">
            <form class="form-horizontal" method="post" action="<?php echo URL; ?>social/editSave/<?=$this->social[0]['social_id']; ?>">
                <fieldset>
                    <!-- Form Name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtQuestions" name="txtQuestions" type="text" placeholder="Facebook" class="form-control input-md" required="" value="<?=$this->social[0]['facebook']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtAnswer1" name="txtAnswer1" type="text" placeholder="Twitter" class="form-control input-md" required="" value="<?=$this->social[0]['twitter']; ?>">
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtAnswer2" name="txtAnswer2" type="text" placeholder="Google Plus" class="form-control input-md" required="" value="<?=$this->social[0]['googleplus']; ?>">
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtAnswer3" name="txtAnswer3" type="text" placeholder="Youtube" class="form-control input-md" required="" value="<?=$this->social[0]['youtube']; ?>">
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtAnswer4" name="txtAnswer4" type="text" placeholder="Linkedin" class="form-control input-md" required="" value="<?=$this->social[0]['linkedin']; ?>">
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtAnswer5" name="txtAnswer5" type="text" placeholder="İnstagram" class="form-control input-md" required="" value="<?=$this->social[0]['instagram']; ?>">
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Button (Double) -->
