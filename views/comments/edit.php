            ...
            <form class="form-horizontal" method="post" action="<?=URL?>comments/create">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input id="txtCommentsName" name="txtCommentsName" type="text" placeholder="Yorum Yapan" class="form-control input-md" required="" value="<?php echo $this->comments[0]['name']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea id="txtComments" name="txtComments" type="text" cols="30" rows="10" required=""><?php echo $this->comments[0]['comments']; ?></textarea>
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Multiple Radios (inline) -->
                    <div class="form-group">
                        <label class="col lg-2 col-md-2 col-sm-3 col-xs-3" for="radios">Onay Durumu</label>
                        <div class="col-md-10">
                            <label class="radio-inline" for="radios-0">
                                <input type="radio" name="txtOnayRadios" id="radios-0" value="0" <?php if ($this->comments[0]['confirm']==0){ echo 'checked'; } ?>>Yorumu Red Et - 0
                            </label>
                            <label class="radio-inline" for="radios-1">
                                <input type="radio" name="txtOnayRadios" id="radios-1" value="1"<?php if ($this->comments[0]['confirm']==1){ echo 'checked'; } ?>>Yorumu Onayla - 1
                            </label>
                        </div>
                    </div>
                    <!-- Button (Double) -->
