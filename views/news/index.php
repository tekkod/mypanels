...
<div class="container t-top hidden-xs ">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 t-rgba-f t-sag" style="overflow-y: scroll;height: 450px">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo URL;?>news/create">
                <fieldset>
                    <!-- Form Name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtNews" name="txtNews" type="text" placeholder="Haber Başlık" class="form-control input-md">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <input id="txtNewsOrder" name="txtNewsOrder" type="text" placeholder="Haber Sırası" class="form-control input-md">
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Text input-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
                            <textarea id="txtNewsDesc" name="txtNewsDesc" type="text" placeholder="İçerik" cols="30" rows="10"></textarea>
                            <span class="help-block">Zorunlu Alan</span>
                        </div>
                    </div>
                    <!-- Text input-->
